    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('faq') }}" class="text-gray-600 hover:text-purple-600 transition-colors">
                            {{ __('FAQ') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('shipping') }}" class="text-gray-600 hover:text-purple-600 transition-colors">
                            {{ __('Shipping & Returns') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('terms') }}" class="text-gray-600 hover:text-purple-600 transition-colors">
                            {{ __('Terms & Conditions') }}
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('privacy') }}" class="text-gray-600 hover:text-purple-600 transition-colors">
                            {{ __('Privacy Policy') }}
                        </a>
                    </li>
                </ul>
