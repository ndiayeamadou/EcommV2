<!-- main.blade.php (Your main layout) -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="bg-gray-50">
    <div x-data="{ sidebarOpen: false }" class="relative min-h-screen flex">
        ...
        <div x-cloak :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
             class="bg-white w-64 md:w-72 fixed h-full overflow-y-auto z-30 transition-transform duration-300 shadow-lg md:translate-x-0">
