<div>
    ...
    <div>
        <form wire:submit="update" class="flex flex-col gap-6 max-w-md mx-auto bg-slate-900 p-4 shadow-2xl rounded-2xl">
            <!-- Title Address -->
            <flux:input
            ...
            <div class="flex gap-2">
                {{-- <img src="{{ asset($form->post->image) }}" class="w-12 h-12 rounded-2xl" alt=""> --}}
                <img src="{{ asset($form->post->image) }}" @class([
            ...
            <div class="flex items-center justify-end">
                <flux:button variant="primary" type="submit" class="w-full">{{ __('Mettre à jour') }}</flux:button>
            </div>
        </form>
    </div>
