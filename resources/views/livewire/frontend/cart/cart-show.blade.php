<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl md:text-3xl font-bold mb-6">@lang('messages.your_shopping_cart') (<span class="text-green-600">{{ $cartCount }}</span>)</h1>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                    ...
                    @foreach($cart as $item)
                        ...
                        >
                            ...
                            <div class="w-full md:w-2/5 flex items-center">
                                ...
                                <div>
                                    ...
                                    <button 
                                        ...
                                        class="text-red-500 text-sm flex items-center mt-1 hover:text-red-700 cursor-pointer"
                                    >
                            ...
                            <div class="w-full md:hidden flex justify-between items-center">
                                <span class="text-sm text-gray-500">{{ucfirst(__('messages.price')) }}:</span>
                            ...
                            <div class="w-full md:w-1/5 flex justify-between md:justify-center items-center">
                                ...
                                <div class="flex items-center border rounded-md">
                                    <button
                                        ...
                                        wire:loading.attr="disabled"
                                        wire:target="decrementQty, updateQuantity"
                                        class="px-2 py-1 text-gray-600 hover:bg-gray-100 cursor-pointer"
                                    >
                                    ...
                                    <button
                                        ...
                                        wire:loading.attr="disabled"
                                        wire:target="incrementQty, updateQuantity"
                                        class="px-2 py-1 text-gray-600 hover:bg-gray-100 cursor-pointer"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="w-full md:hidden flex justify-between items-center">
                                ...
                                <span class="font-semibold">${{ number_format($item->product->selling_price * $item->quantity, 2) }}</span>
                            </div>
                    ...
                    <div class="flex justify-between items-center mt-6">
                        ...
                        <button 
                            ...
                            class="text-red-500 border-red-500 hover:bg-red-50 inline-flex items-center px-4 py-2 border rounded-md text-sm font-medium cursor-pointer"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                            </svg>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow-sm p-6 sticky top-24">
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="border-t pt-3 mt-3">
                            <div class="flex justify-between font-semibold text-lg">
                                <span>Total</span>
                                <span>{{ number_format($totalPrice) }} F</span>
                            </div>
                            <p class="text-gray-500 text-sm mt-1">{{ __('messages.including_VAT') }}</p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <span wire:loading.remove wire:target="checkout" class="cursor-pointer">
